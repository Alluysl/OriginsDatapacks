...
scale set pehkui:width 2 @e[type=minecraft:item_frame,tag=celeste_refill_gem]
scale set pehkui:height 2 @e[type=minecraft:item_frame,tag=celeste_refill_gem]