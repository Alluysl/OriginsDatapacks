...
execute as @e[type=minecraft:item_frame,tag=celeste_refill_gem,distance=..2,sort=nearest,limit=1] at @s run function celeste:refill_gem/internal/get_destroyed
