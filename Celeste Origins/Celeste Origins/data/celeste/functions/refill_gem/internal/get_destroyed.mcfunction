...
execute if score $dropOnDestroy clst_rg_crafting matches 1.. if entity @a[gamemode=!creative,gamemode=!spectator,distance=..8] unless entity @a[gamemode=creative,distance=..8] run function celeste:refill_gem/internal/summon_spawner
# Kill self
kill