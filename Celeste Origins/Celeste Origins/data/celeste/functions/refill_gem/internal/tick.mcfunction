execute as @e[tag=celeste_refill_gem] run function celeste:refill_gem/internal/tick_gem
execute as @e[tag=celeste_refill_gem_destroyer] at @s run function celeste:refill_gem/destroy
