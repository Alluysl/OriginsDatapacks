# Just makes the feathers visually bigger (also increases the size of the hitbox of the item frame, but not of the gem)
...
scale set pehkui:width 2 @e[tag=celeste_feather]
scale set pehkui:height 2 @e[tag=celeste_feather]