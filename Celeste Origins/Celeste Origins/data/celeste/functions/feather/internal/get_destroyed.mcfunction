...
execute if score $dropOnDestroy clst_ft_crafting matches 1.. if entity @p[gamemode=!creative,gamemode=!spectator,distance=..8] unless entity @p[gamemode=creative,distance=..8] run function celeste:feather/internal/summon_spawner
# Kill self
kill